...
// const details = [
//   {
//     image: `<img src="images/profile.png" alt="">`,
//     name:{
//       title: "Emily Williams",
//       genderAge: "Female, 18"
//     },
//     icon: `<i class="ri-more-line"></i>`
//   },
//   {
//     image: `<img src="images/profile.png" alt="">`,
//     name:{
...
//   const contacts = document.getElementById("personal-details")
// let productElement = ''
// details.forEach((detail)=>{
//   productElement += `
//     <div class="personal-details personal-details-patient">
//             <div class="icon-name">
//               <div class="image-icon">
//                 ${detail.image}
//               </div>
//                 <div class="name">
//                   <h6>${detail.name.title}</h6>
//                   <h6 class="name-title gender">${detail.name.genderAge}</h6>
//                 </div>
//             </div>
//               <div class="setting-menu-icons">
//                 ${detail.icon}
//               </div>
//           </div>
// `
// })
// contacts.innerHTML = productElement;
...
details.forEach((detail) => {
  productElement += `
    <div class="patients-personal-details details-class">
      <div class="content-image">
        <img src="${detail.profile_picture}" alt="${detail.name}'s profile picture">
        <div class="name-age">
          <p class="name">${detail.name}</p>
          <p class="age">${detail.gender}, ${detail.age}</p>
        </div>
      </div>
      <div class="icons">
...
// Optionally append the generated content to the `contacts` element
contacts.innerHTML = productElement;
...
new Chart(ctx, {
  type: 'line',
  data: {
    labels: ['Oct, 2023', 'Nov, 2023', 'Dec, 2023', 'Jan, 2024', 'Feb, 2024', 'March, 2024'],
    datasets: [{
      label: '# of Votes',
